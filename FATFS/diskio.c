...
__weak DWORD get_fattime(void) {
	...
	return	  ((DWORD)((RTC_DateStructure.RTC_Year)+20) << 25)	/* Year 2013 */
			| ((DWORD)RTC_DateStructure.RTC_Month << 21)				/* Month 7 */
			| ((DWORD)RTC_DateStructure.RTC_Date << 16)				/* Mday 28 */
			| ((DWORD)RTC_TimeStructure.RTC_Hours << 11)				/* Hour 0 */
			| ((DWORD)RTC_TimeStructure.RTC_Minutes << 5)				/* Min 0 */
			| ((DWORD)RTC_TimeStructure.RTC_Seconds >> 1);				/* Sec 0 */
}
