...
//	
//	LCD_ShowFontCN_40_55(60+40*7,70,40,55,(uint8_t*)Out_Assic+27*40*55/8);//V
//	
//	LCD_ShowFontCN_40_55(60+40*7,70+55,40,55,(uint8_t*)Out_Assic+28*40*55/8);//Ω
	static u8 ascii;
	ascii = *unit - '!';
	
	
	LCD_ShowFontCN_40_55(60+40*7,80,40,40,(uint8_t*)Out_Assic30+ascii*40*40/8);//V
	
//	LCD_ShowFontCN_40_55(60+40*7,80+30,30,30,(uint8_t*)Out_Assic30+2*30*30/8);//Ω
...
void Disp_EN40(u16 x,u16 y, const uint8_t *pcStr)
{
	uint16_t usWidth = 0;
	while(1)
	{
		...
		LCD_ShowFontCN_40_55(x+usWidth,y,40,40,(uint8_t*)Out_Assic30+(*pcStr-' ')*40*40/8);
		pcStr += 1;
		usWidth+=28;
	}
}	
